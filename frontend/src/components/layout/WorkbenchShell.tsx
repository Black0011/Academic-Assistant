...
export function WorkbenchShell({
  ...
  return (
    ...
    <div className="flex h-[calc(100vh-3.5rem)] flex-col">
      {/* Pane toggles always visible so a hidden pane can be restored */}
      <div className="flex h-8 shrink-0 items-center gap-1 border-b bg-[var(--color-card)]/30 px-2">
        <PaneToggle
          visible={leftVisible}
          onClick={toggleLeft}
        ...
        {toolbar ? (
          <>
            <div className="ml-1 h-4 w-px bg-[var(--color-border)]" />
            {toolbar}
          </>
        ) : null}
      </div>
